|package|version|typed|top-level module|score|stubs|description|downloads|
|---|---|---|---|---|---|---|---|
|boto3|1.25.1|False|boto3|19.2%|boto3-stubs 1.25.1|The AWS SDK for Python|376423964|
|botocore|1.28.1|False|botocore|20.1%|botocore-stubs 1.27.96|Low-level, data-driven core of boto 3.|238905727|
|urllib3|1.26.12|False|urllib3|21.9%|typeshed|HTTP library with thread-safe connection pooling, file post, and more.|233856611|
|setuptools|65.5.0|False|_distutils_hack|0%|typeshed|Easily download, build, install, upgrade, and uninstall Python packages|214855886|
|setuptools|65.5.0|False|pkg_resources|9.5%|typeshed|Easily download, build, install, upgrade, and uninstall Python packages|214855886|
|setuptools|65.5.0|False|setuptools|15.3%|typeshed|Easily download, build, install, upgrade, and uninstall Python packages|214855886|
|requests|2.28.1|False|requests|13.6%|typeshed|Python HTTP for Humans.|212621430|
|s3transfer|0.6.0|False|s3transfer|10.1%|types-s3transfer 0.6.0.post4|An Amazon S3 Transfer Manager|191496632|
|google-api-core|2.10.2|False|google|33.1%|None|Google API client core library|172912499|
|charset-normalizer|2.1.1|True|charset_normalizer|94.1%|None|The Real First Universal Charset Detector. Open, modern and actively maintained alternative to Chardet.|169294743|
|certifi|2022.9.24|True|certifi|71.4%|typeshed|Python package for providing Mozilla's CA Bundle.|166702759|
|python-dateutil|2.8.2|False|dateutil|20.1%|typeshed|Extensions to the standard Python datetime module|166700747|
|idna|3.4|True|idna|94.4%|None|Internationalized Domain Names in Applications (IDNA)|163826476|
|typing-extensions|4.4.0|False|typing_extensions|30.1%|types-typing-extensions 3.7.3|Backported and Experimental Type Hints for Python 3.7+|162095439|
|six|1.16.0|False|six|4.9%|typeshed|Python 2 and 3 compatibility utilities|159384285|
|PyYAML|6.0|False|_yaml|50%|typeshed|YAML parser and emitter for Python|152896954|
|PyYAML|6.0|False|yaml|14.2%|typeshed|YAML parser and emitter for Python|152896954|
|cryptography|38.0.1|True|cryptography|82.8%|typeshed|cryptography is a package which provides cryptographic recipes and primitives to Python developers.|138618886|
|awscli|1.26.1|False|awscli|29.8%|None|Universal Command Line Environment for AWS.|134047956|
|numpy|1.23.4|True|numpy|13.3%|None|NumPy is the fundamental package for array computing with Python.|128328565|
|wheel|0.37.1|False|wheel|31%|None|A built-package format for Python|113964602|
|pyparsing|3.0.9|True|pyparsing|29.1%|None|pyparsing module - Classes and methods to define and execute parsing grammars|111279560|
|rsa|4.9|True|rsa|60.7%|None|Pure-Python RSA implementation|110184314|
|packaging|21.3|True|packaging|76.7%|None|Core utilities for Python packages|109874716|
|pyasn1|0.4.8|False|pyasn1|7.9%|None|ASN.1 types and codecs|106674235|
|pip|22.3|True|pip|42.9%|None|The PyPA recommended tool for installing Python packages.|106506648|
|pytz|2022.5|False|pytz|21.6%|typeshed|World timezone definitions, modern and historical|106042945|
|jmespath|1.0.1|False|jmespath|21.9%|typeshed|JSON Matching Expressions|102854622|
|PyJWT|2.6.0|True|jwt|38.4%|types-PyJWT 1.7.1|JSON Web Token implementation in Python|101884675|
|importlib-metadata|4.13.0|True|importlib_metadata|8.8%|None|Read metadata from Python packages|101600292|
|pandas|1.5.1|False|pandas|8.7%|pandas-stubs 1.5.1.221024|Powerful data structures for data analysis, time series, and statistics|100256846|
|zipp|3.10.0|False|zipp|11.4%|None|Backport of pathlib-compatible object wrapper for zip files|99617758|
|colorama|0.4.6|False|colorama|35.3%|typeshed|Cross-platform colored terminal text.|96392667|
|oauthlib|3.2.2|False|oauthlib|22.3%|typeshed|A generic, spec-compliant, thorough implementation of the OAuth request-signing logic|91619622|
|attrs|22.1.0|True|attr|99%|types-attrs 19.1.0|Classes Without Boilerplate|90504247|
|attrs|22.1.0|True|attrs|98.5%|types-attrs 19.1.0|Classes Without Boilerplate|90504247|
|click|8.1.3|True|click|66.3%|types-click 7.1.8|Composable command line interface toolkit|90075871|
...
|soupsieve|2.3.2.post1|True|soupsieve|61.7%|None|A modern CSS selector implementation for Beautiful Soup.|44770008|
...
|pydantic|1.10.2|True|pydantic|82.1%|None|Data validation and settings management using python type hints|33445871|
...
|pycryptodomex|3.15.0|True|Cryptodome|25.8%|None|Cryptographic library for Python|24957481|
...
|asynctest|0.13.0|False|asynctest|31.6%|None|Enhance the standard unittest package with features for testing asyncio libraries|19731859|
...
|flake8|5.0.4|False|flake8|75.7%|None|the modular source code checker: pep8 pyflakes and co|15241929|
...
|setuptools-scm|7.0.5|False|setuptools_scm|66.9%|None|the blessed package to manage your versions by scm tags|12644378|
...
|requests-file|1.5.1|False|requests_file|0%|None|File transport adapter for Requests|10660040|
...
|keras|2.10.0|False|keras|6.8%|None|Deep learning for humans.|9339741|
...
|fastapi|0.85.1|True|fastapi|66.1%|None|FastAPI framework, high performance, easy to learn, fast to code, ready for production|8293410|
...
|exceptiongroup|1.0.0rc9|True|exceptiongroup|85.7%|None|Backport of PEP 654 (exception groups)|7368993|
...
|deepdiff|6.2.1|False|deepdiff|23.4%|None|Deep Difference and Search of any Python object/data. Recreate objects by adding adding deltas to each other.|6482340|
...
|azure-graphrbac|0.61.1|False|azure.graphrbac|24.5%|None|Microsoft Azure Graph RBAC Client Library for Python|5800352|
...
|great-expectations|0.15.28|False|great_expectations|36.2%|None|Always know what to expect from your data.|5339265|
...
|libclang|14.0.6|False|clang|27.6%|None|Clang Python Bindings, mirrored from the official LLVM repo: https://github.com/llvm/llvm-project/tree/main/clang/bindings/python, to make the installation process easier.|4852511|
...
|munch|2.5.0|False|munch|8%|munch-stubs 0.1.2|A dot-accessible dictionary (a la JavaScript objects)|4397006|
...
|phonenumbers|8.12.57|True|phonenumbers|97.3%|None|Python version of Google's common library for parsing, formatting, storing and validating international phone numbers.|3868970|
...
|azure-kusto-data|3.1.3|False|azure|8.4%|None|Kusto Data Client|3465755|
...
|pip-tools|6.9.0|True|piptools|55.3%|None|pip-tools keeps your pinned dependencies fresh.|3157282|
...
|autopep8|1.7.0|False|autopep8|12.9%|None|A tool that automatically formats Python code to conform to the PEP 8 style guide|3035878|
...
|cmdstanpy|1.0.8|True|cmdstanpy|73.3%|None|Python interface to CmdStan|2945433|
...
|click-repl|0.2.0|False|click_repl|37.5%|None|REPL plugin for Click|2922077|
|jaydebeapi|1.2.3|False|jaydebeapi|34.2%|None|Use JDBC database drivers from Python 2/3 or Jython with a DB-API.|2921006|
|azure-eventgrid|4.9.0|True|azure.eventgrid|20%|None|Microsoft Azure Event Grid Client Library for Python|2918772|
|jupyter|1.0.0|False|jupyter|0%|None|Jupyter metapackage. Install all the Jupyter components in one go.|2917221|
|yamllint|1.28.0|False|yamllint|50.2%|None|A linter for YAML files.|2910338|
|requests-mock|1.10.0|True|requests_mock|58.1%|None|Mock out responses from the requests package|2907589|
|idna-ssl|1.1.0|False|idna_ssl|20%|None|Patch ssl.match_hostname for Unicode(idna) domains support|2903000|
|twisted|22.8.0|True|twisted|15.7%|None|An asynchronous networking framework written in Python|2889074|
|sasl|0.3.1|False|sasl|0%|None|Cyrus-SASL bindings for Python|2879381|
|google-cloud-language|2.6.1|True|google.cloud.language|0%|None|Google Cloud Natural Language API client library|2877643|
|imageio-ffmpeg|0.4.7|False|imageio_ffmpeg|0%|None|FFMPEG wrapper for Python|2849141|
|cherrypy|18.8.0|False|cherrypy|12.6%|None|Object-Oriented HTTP framework|2830266|
|google|3.0.0|False|googlesearch|35%|None|Python bindings to the Google search engine.|2825227|
|pathlib|1.0.1|False|pathlib|0%|None|Object-oriented filesystem paths|2821355|
|backports.tempfile|1.0|False|backports|0%|None|Backport of new features in Python's tempfile module|2811091|
|makefun|1.15.0|True|makefun|22.2%|None|Small library to dynamically create python functions.|2776905|
|ddtrace|1.5.2|False|benchmarks|16.7%|None|Datadog APM client library|2768677|
|ddtrace|1.5.2|True|ddtrace|45.2%|None|Datadog APM client library|2768677|
|ddtrace|1.5.2|False|ddtrace_gevent_check|0%|None|Datadog APM client library|2768677|
|pyserial|3.5|False|serial|38.5%|None|Python Serial Port Extension|2768543|
|contourpy|1.0.5|False|contourpy|3.5%|None|Python library for calculating contours of 2D quadrilateral grids|2742229|
|sekkaybot|0.22.232|False|sekkaybot|0%|None|Lobby bot.|2739889|
|google-cloud-videointelligence|2.8.3|True|google.cloud.videointelligence|0%|None|Google Cloud Video Intelligence API client library|2733567|
|google-cloud-monitoring|2.11.3|True|google.cloud.monitoring|0%|None|Stackdriver Monitoring API client library|2711427|
|tempora|5.0.2|False|tempora|13.5%|None|Objects and routines pertaining to date and time (tempora)|2707884|
|lunarcalendar|0.0.9|False|lunarcalendar|10.9%|None|A lunar calendar converter, including a number of lunar and solar holidays, mainly from China.|2705760|
|pygeohash|1.2.0|False|pygeohash|10.7%|None|Python module for interacting with geohashes|2699612|
|sphinx-rtd-theme|1.0.0|False|sphinx_rtd_theme|20%|None|Read the Docs theme for Sphinx|2684785|
|spark-nlp|4.2.1|False|com|0%|None|John Snow Labs Spark NLP is a natural language processing library built on top of Apache Spark ML. It provides simple, performant & accurate NLP annotations for machine learning pipelines, that scale easily in a distributed environment.|2655131|
|spark-nlp|4.2.1|False|sparknlp|5.8%|None|John Snow Labs Spark NLP is a natural language processing library built on top of Apache Spark ML. It provides simple, performant & accurate NLP annotations for machine learning pipelines, that scale easily in a distributed environment.|2655131|
|portend|3.1.0|False|portend|14.3%|None|TCP port monitoring and discovery|2654674|
|kfp|1.8.14|False|kfp|40%|None|KubeFlow Pipelines SDK|2629471|
|zict|2.2.0|True|zict|63.4%|None|Mutable mapping tools|2626064|
|pyhocon|0.3.59|False|pyhocon|23.1%|None|HOCON parser for Python|2601124|
|fabric|2.7.1|False|fabric|11.8%|None|High level SSH command execution|2597396|
|uritools|4.0.0|False|uritools|42.9%|None|URI parsing, classification and composition|2596666|
|elasticsearch-dsl|7.4.0|False|elasticsearch_dsl|23.3%|None|Python client for Elasticsearch|2592381|
|django-cors-headers|3.13.0|True|corsheaders|61.5%|None|django-cors-headers is a Django application for handling the server headers required for Cross-Origin Resource Sharing (CORS).|2583256|
|parse|1.19.0|False|parse|32.9%|None|parse() is the opposite of format()|2583130|
|heapdict|1.0.1|False|heapdict|0%|None|a heap with decrease-key and increase-key operations|2575714|
|polling|0.3.2|False|polling|10%|None|Powerful polling utility with many configurable options|2571860|
|ftfy|6.1.1|True|ftfy|62.3%|None|Fixes mojibake and other problems with Unicode, after the fact|2563329|
|frozendict|2.3.4|True|frozendict|7%|types-frozendict 2.0.9|A simple immutable dictionary|2554844|
|linkify-it-py|2.0.0|False|linkify_it|25.5%|None|Links recognition library with FULL unicode support.|2547504|
|sympy|1.11.1|False|isympy|0%|None|Computer algebra system (CAS) in Python|2545232|
|sympy|1.11.1|True|sympy|4.4%|None|Computer algebra system (CAS) in Python|2545232|
|aws-requests-auth|0.4.3|False|aws_requests_auth|26.3%|aws-requests-auth-stubs 0.4.3.2|AWS signature version 4 signing process for the python requests module|2544046|
|tableauserverclient|0.23|True|tableauserverclient|42.6%|None|A Python module for working with the Tableau Server REST API.|2542080|
|numexpr|2.8.4|False|numexpr|12.9%|None|Fast numerical expression evaluator for NumPy|2534695|
|sarif-om|1.0.4|False|sarif_om|0%|None|Classes implementing the SARIF 2.1.0 object model.|2532871|
|mpmath|1.2.1|False|mpmath|3%|None|Python library for arbitrary-precision floating-point arithmetic|2524942|
|hyperlink|21.0.0|True|hyperlink|85.9%|None|A featureful, immutable, and correct URL for Python.|2520671|
|azure-cli|2.41.0|False|azure|0%|None|Microsoft Azure Command-Line Tools|2514100|
|pytorch-lightning|1.7.7|True|pytorch_lightning|51.4%|None|PyTorch Lightning is the lightweight PyTorch wrapper for ML researchers. Scale your models. Write less boilerplate.|2505071|
|jschema-to-python|1.2.3|False|jschema_to_python|13.3%|None|Generate source code for Python classes from a JSON schema.|2487939|
|backports.csv|1.0.7|False|backports|29.4%|None|Backport of Python 3 csv module|2485414|
|pydeequ|1.0.1|False|pydeequ|20.3%|None|PyDeequ - Unit Tests for Data|2484347|
|tld|0.12.6|True|tld|35.3%|None|Extract the top-level domain (TLD) from the URL given.|2473454|
|spacy-legacy|3.0.10|False|spacy_legacy|15.4%|None|Legacy registered functions for spaCy backwards compatibility|2466453|
|resolvelib|0.8.1|True|resolvelib|75.3%|None|Resolve abstract dependencies into concrete ones|2462230|
|kfp-server-api|1.8.5|False|kfp_server_api|4.1%|None|Kubeflow Pipelines API|2461017|
|pathy|0.6.2|True|pathy|95.5%|None|pathlib.Path subclasses for local and cloud bucket storage|2460295|
|pytest-metadata|2.0.3|False|pytest_metadata|50%|None|pytest plugin for test session metadata|2459784|
|strip-hints|0.1.10|False|strip_hints|21%|None|Function and command-line program to strip Python type hints.|2449534|
|autocommand|2.2.1|False|autocommand|50%|None|A library to create a command-line program from a function|2446773|
|boto3-stubs|1.25.1|True|boto3-stubs|93.4%|None|Type annotations for boto3 1.25.1 generated with mypy-boto3-builder 7.11.10|2440897|
|ntlm-auth|1.5.0|False|ntlm_auth|45.7%|None|Creates NTLM authentication structures|2431592|
|automat|20.2.0|False|automat|0%|None|Self-service finite-state machines for the programmer on the go.|2422898|
|sqlalchemy-redshift|0.8.11|False|redshift_sqlalchemy|100%|None|Amazon Redshift Dialect for sqlalchemy|2418597|
|sqlalchemy-redshift|0.8.11|False|sqlalchemy_redshift|30%|None|Amazon Redshift Dialect for sqlalchemy|2418597|
|python-multipart|0.0.5|False|multipart|31%|None|A streaming multipart parser for Python|2401974|
|apache-airflow-providers-amazon|6.0.0|True|airflow|41.3%|None|Provider for Apache Airflow. Implements apache-airflow-providers-amazon package|2393246|
|SQLAlchemy-JSONField|1.0.0|False|sqlalchemy_jsonfield|35.7%|None|SQLALchemy JSONField implementation for storing dicts at SQL|2379238|
|Flask-Compress|1.13|False|flask_compress|12.5%|None|Compress responses in your Flask app with gzip, deflate or brotli.|2375965|
|azure-kusto-ingest|3.1.3|False|azure.kusto.ingest|50.3%|None|Kusto Ingest Client|2374058|
|jellyfish|0.9.0|True|jellyfish|17.5%|None|a library for doing approximate and phonetic matching of strings.|2371157|
|ipdb|0.13.9|False|ipdb|8%|None|IPython-enabled pdb|2370201|
|ansible-core|2.13.5|False|ansible|29.3%|None|Radically simple IT automation|2365548|
|ansible-core|2.13.5|False|ansible_test|0%|None|Radically simple IT automation|2365548|
|cron-descriptor|1.2.31|False|cron_descriptor|36%|None|A Python library that converts cron expressions into human readable strings.|2364914|
|python-consul|1.1.0|False|consul.__init__|0%|None|Python client for Consul (http://www.consul.io/)|2357309|
|python-consul|1.1.0|False|consul.aio|7.7%|None|Python client for Consul (http://www.consul.io/)|2357309|
|python-consul|1.1.0|False|consul.base|15.3%|None|Python client for Consul (http://www.consul.io/)|2357309|
|python-consul|1.1.0|False|consul.std|0%|None|Python client for Consul (http://www.consul.io/)|2357309|
|python-consul|1.1.0|False|consul.tornado|0%|None|Python client for Consul (http://www.consul.io/)|2357309|
|python-consul|1.1.0|False|consul.twisted|0%|None|Python client for Consul (http://www.consul.io/)|2357309|
|moviepy|1.0.3|False|moviepy|20.6%|None|Video editing with Python|2353597|
|pytest-timeout|2.1.0|False|pytest_timeout|28.6%|None|pytest plugin to abort hanging tests|2351307|
|constantly|15.1.0|False|constantly|0%|None|Symbolic constants in Python|2348494|
|pathtools|0.1.2|False|pathtools|29.4%|None|File system general utilities|2345868|
|uc-micro-py|1.0.1|False|uc_micro|100%|None|Micro subset of unicode data files for linkify-it-py projects.|2334687|
|python-jenkins|1.7.0|False|jenkins|39.5%|None|Python bindings for the remote Jenkins API|2333784|
|hiredis|2.0.0|True|hiredis|100%|None|Python wrapper for hiredis|2332200|
|proglog|0.1.10|False|proglog|11.3%|None|Log and progress bar manager for console, notebooks, web...|2330834|
|django-filter|22.1|False|django_filters|4.4%|django-filter-stubs 0.1.1|Django-filter is a reusable Django application for allowing users to filter querysets dynamically.|2321246|
|multi-key-dict|2.0.3|False|multi_key_dict|0%|None|Multi key dictionary implementation|2315560|
|langcodes|3.3.0|True|langcodes|63.4%|None|Tools for labeling human languages with IETF language tags|2309443|
|pytest-html|3.2.0|False|pytest_html|24.7%|None|pytest plugin for generating HTML reports|2296236|
|bitarray|2.6.0|True|bitarray|11.1%|None|efficient arrays of booleans -- C extension|2290824|
|catboost|1.1|False|catboost|19.6%|None|Catboost Python Package|2289999|
|python-snappy|0.6.1|False|snappy|29.3%|None|Python library for the snappy compression library from Google|2286338|
|yapf|0.32.0|False|yapf|31.6%|None|A formatter for Python code.|2285751|
|yapf|0.32.0|False|yapftests|0.8%|None|A formatter for Python code.|2285751|
|strict-rfc3339|0.7|False|strict_rfc3339|12.5%|None|Strict, simple, lightweight RFC3339 functions|2285166|
|google-apitools|0.5.32|False|apitools|18.6%|None|client libraries for humans|2265076|
|findspark|2.0.1|False|findspark|0%|None|Find pyspark to make it importable.|2261744|
|apache-airflow-providers-common-sql|1.2.0|False|airflow|40.9%|None|Provider for Apache Airflow. Implements apache-airflow-providers-common-sql package|2255290|
|testpath|0.6.0|False|testpath|7%|None|Test utilities for code working with files and commands|2255079|
|h3|3.7.4|False|h3|2.4%|None|Hierarchical hexagonal geospatial indexing system|2249321|
|python-gitlab|3.10.0|True|gitlab|52.9%|None|Interact with GitLab API|2241536|
|requests-ntlm|1.1.0|False|requests_ntlm|28.6%|None|This package allows for HTTP NTLM authentication using the requests library.|2239281|
|service-identity|21.1.0|False|service_identity|87.3%|None|Service identity verification for pyOpenSSL & cryptography.|2238609|
|gsutil|5.15|False|gslib|11.3%|None|A command line tool for interacting with cloud storage services.|2224996|
|w3lib|2.0.1|True|w3lib|94.8%|None|Library of web-related functions|2218008|
|spacy-loggers|1.0.3|False|spacy_loggers|10%|None|Logging utilities for SpaCy|2210841|
|pyotp|2.7.0|True|pyotp|78.7%|None|Python One Time Password Library|2209022|
|pyrogram|2.0.59|True|pyrogram|60.6%|None|Elegant, modern and asynchronous Telegram MTProto API framework in Python for users and bots|2207181|
|azure-devops|6.0.0b4|False|azure|1.6%|None|Python wrapper around the Azure DevOps 6.x APIs|2190134|
|kfp-pipeline-spec|0.1.16|False|kfp|0%|None|Kubeflow Pipelines pipeline spec|2181606|
|aws-psycopg2|1.3.8|False|psycopg2|62.9%|None|A aws psycopg2 package from psycopg2.|2172393|
|xarray|2022.10.0|True|xarray|31%|None|N-D labeled arrays and datasets in Python|2172371|
|schema|0.7.5|False|schema|11.6%|None|Simple data validation library|2169847|
|azure-appconfiguration|1.3.0|True|azure.appconfiguration|33.3%|None|Microsoft App Configuration Data Library for Python|2163352|
|pyaml|21.10.1|False|pyaml|5.7%|None|PyYAML-based module to produce pretty and readable YAML-serialized data|2162186|
|yt-dlp|2022.10.4|False|yt_dlp|27.6%|None|A youtube-dl fork with additional features and patches|2148792|
|python3-openid|3.2.0|False|openid|23.6%|None|OpenID support for modern servers and consumers.|2146258|
|twilio|7.15.0|False|twilio|20.9%|twilio-stubs 0.1.0|Twilio API client and TwiML generator|2146108|
|urllib3-secure-extra|0.1.0|False|urllib3_secure_extra|0%|None|Marker library to detect whether urllib3 was installed with the deprecated [secure] extra|2123589|
|configobj|5.0.6|False|_version|0%|None|Config file reading, writing and validation.|2119699|
|configobj|5.0.6|False|configobj|16.3%|None|Config file reading, writing and validation.|2119699|
|configobj|5.0.6|False|validate|9.8%|None|Config file reading, writing and validation.|2119699|
|pyaes|1.6.1|False|pyaes|34.2%|None|Pure-Python Implementation of the AES block-cipher and common modes of operation|2116815|
|resampy|0.4.2|False|resampy|35.3%|None|Efficient signal resampling|2115837|
|influxdb|5.3.1|False|influxdb|5.2%|None|InfluxDB client|2112434|
|omegaconf|2.2.3|True|omegaconf|50.8%|None|A flexible configuration library|2094939|
|omegaconf|2.2.3|False|pydevd_plugins|63.2%|None|A flexible configuration library|2094939|
|bandit|1.7.4|False|bandit|24.3%|None|Security oriented static analyser for python code.|2087703|
|onnxruntime|1.13.1|False|onnxruntime|12.4%|None|ONNX Runtime is a runtime accelerator for Machine Learning models|2076723|
|cmd2|2.4.2|True|cmd2|86.6%|None|cmd2 - quickly build feature-rich and user-friendly interactive command line applications in Python|2071051|
|marshmallow-oneofschema|3.0.1|False|marshmallow_oneofschema|30%|None|marshmallow multiplexing schema|2068220|
|torchmetrics|0.10.1|True|torchmetrics|51.1%|None|PyTorch native Metrics|2060372|
|configargparse|1.5.3|False|configargparse|30.6%|None|A drop-in replacement for argparse that allows options to also be set via config files and/or environment variables.|2058560|
|pytest-rerunfailures|10.2|False|pytest_rerunfailures|20%|None|pytest plugin to re-run tests to eliminate flaky failures|2050421|
|openapi-spec-validator|0.5.1|True|openapi_spec_validator|40%|None|OpenAPI 2.0 (aka Swagger) and OpenAPI 3 spec validator|2048924|
|backports.functools-lru-cache|1.6.4|False|backports|0%|None|Backport of functools.lru_cache|2048791|
|pyrfc3339|1.1|False|pyrfc3339|0%|types-pyRFC3339 1.1.1|Generate and parse RFC 3339 timestamps|2044571|
|azure-storage-file|2.1.0|False|azure.storage.file|6.6%|None|Microsoft Azure Storage File Client Library for Python|2043130|
|terminaltables|3.1.10|False|terminaltables|78.4%|None|Generate simple tables in terminals from a nested list of strings.|2020833|
|dbt-core|1.3.0|True|dbt|61.7%|None|With dbt, data analysts and engineers can build analytics the way engineers build applications.|2017286|
|clickclick|20.10.2|False|clickclick|15.1%|None|Click utility functions|2003666|
|pycurl|7.45.1|False|curl|3.8%|typeshed|PycURL -- A Python Interface To The cURL library|2002443|
|cookiecutter|2.1.1|False|cookiecutter|27%|None|A command-line utility that creates projects from project templates, e.g. creating a Python package project from a Python package project template.|2000791|
|pyee|9.0.4|True|pyee|54%|None|A port of node.js's EventEmitter to python.|1997171|
|pydocstyle|6.1.1|False|pydocstyle|24.1%|None|Python docstring style checker|1991974|
|timezonefinder|6.1.5|True|timezonefinder|71.4%|None|fast python package for finding the timezone of any point on earth (coordinates) offline|1984591|
|redis-py-cluster|2.1.3|False|rediscluster|11.6%|None|Library for communicating with Redis Clusters. Built on top of redis-py lib|1980383|
|curlify|2.2.1|False|curlify|0%|None|Library to convert python requests object to curl command.|1973512|
|javaproperties|0.8.1|True|javaproperties|88.2%|None|Read & write Java .properties files|1973042|
|rx|3.2.0|True|rx|34.8%|None|Reactive Extensions (Rx) for Python|1969237|
|elastic-transport|8.4.0|True|elastic_transport|52.5%|None|Transport classes and utilities shared among Python Elastic client libraries|1966547|
|mypy-boto3-rds|1.25.1|True|mypy_boto3_rds|90.9%|None|Type annotations for boto3.RDS 1.25.1 service generated with mypy-boto3-builder 7.11.10|1964679|
|opencv-python-headless|4.6.0.66|False|cv2|7.2%|None|Wrapper package for OpenCV python bindings.|1964235|
|mypy-boto3-s3|1.25.0|True|mypy_boto3_s3|88%|None|Type annotations for boto3.S3 1.25.0 service generated with mypy-boto3-builder 7.11.10|1963391|
|kazoo|2.9.0|False|kazoo|15.5%|types-kazoo 0.1.3|"Higher Level Zookeeper Client"|1960769|
|ninja|1.10.2.4|True|ninja|37.5%|None|Ninja is a small build system with a focus on speed|1959943|
|boltons|21.0.0|False|boltons|11.2%|None|When they're not builtins, they're boltons.|1956455|
|sqlalchemy-json|0.5.0|False|sqlalchemy_json|2.6%|None|JSON type with nested change tracking for SQLAlchemy|1951754|
|gspread-dataframe|3.3.0|False|gspread_dataframe|25%|None|Read/write gspread worksheets using pandas DataFrames|1951328|
|ray|2.0.1|True|ray|21.9%|None|Ray provides a simple, universal API for building distributed applications.|1950241|
|passlib|1.7.4|False|passlib|17.8%|typeshed|comprehensive password hashing framework supporting over 30 schemes|1949806|
|youtube-search-python|1.6.6|False|youtubesearchpython|28.5%|None|Search for YouTube videos, channels & playlists & get video information using link WITHOUT YouTube Data API v3|1940496|
|msgpack-python|0.5.6|False|msgpack|45.7%|None|MessagePack (de)serializer.|1936842|
|binaryornot|0.4.4|False|binaryornot|0%|None|Ultra-lightweight pure Python package to check if a file is binary or text.|1936608|
|cliff|4.0.0|False|cliff|14%|None|Command Line Interface Formulation Framework|1927516|
|jinja2-time|0.2.0|False|jinja2_time|16.7%|None|Jinja2 Extension for Dates and Times|1926256|
|tensorflow-addons|0.18.0|False|tensorflow_addons|13.9%|None|TensorFlow Addons.|1912231|
|dpath|2.0.6|False|dpath|32.4%|None|Filesystem-like pathing and searching for dictionaries|1910905|
|jikanpy|4.3.2|True|jikanpy|85.1%|None|Python wrapper for the Jikan API|1908836|
|flower|1.2.0|False|flower|22.8%|None|Celery Flower|1900623|
|pyDeprecate|0.3.2|False|deprecate|76.9%|None|Deprecation tooling|1897307|
|unittest-xml-reporting|3.2.0|False|xmlrunner|23.4%|None|unittest-based test runner with Ant/JUnit like XML reporting.|1890159|
|types-setuptools|65.5.0.2|False|pkg_resources-stubs|100%|None|Typing stubs for setuptools|1886255|
|types-setuptools|65.5.0.2|False|setuptools-stubs|26.9%|None|Typing stubs for setuptools|1886255|
|z3-solver|4.11.2.0|False|z3|27%|None|an efficient SMT solver library|1880399|
|azure-multiapi-storage|0.10.0|False|azure.multiapi.storage|15.7%|None|Microsoft Azure Storage Client Library for Python with multi API version support.|1868400|
|urlextract|1.7.1|False|urlextract|37.1%|None|Collects and extracts URLs from given text.|1853880|
|jupyterlab-server|2.16.1|False|jupyterlab_server|22.2%|None|A set of server components for JupyterLab and JupyterLab like applications.|1844190|
|fortnitepy|3.6.7|False|fortnitepy|48.3%|None|Library for interacting with fortnite services|1841605|
|swagger-ui-bundle|0.0.9|False|swagger_ui_bundle|50%|None|swagger_ui_bundle - swagger-ui files in a pip package|1839101|
|factory-boy|3.2.1|False|factory|23.5%|types-factory-boy 0.3.0|A versatile test fixtures replacement based on thoughtbot's factory_bot for Ruby.|1838685|
|fastparquet|0.8.3|False|fastparquet|39.6%|None|Python support for Parquet file format|1809381|
|ciso8601|2.2.0|True|ciso8601|100%|None|Fast ISO8601 date time parser for Python written in C|1808378|
|types-pytz|2022.5.0.0|False|pytz-stubs|82.1%|None|Typing stubs for pytz|1804096|
|xxhash|3.1.0|True|xxhash|100%|typeshed|Python binding for xxHash|1800056|
|pydub|0.25.1|False|pydub|13.8%|pydub-stubs 0.25.1.0|Manipulate audio with an simple and easy high level interface|1797986|
|django-storages|1.13.1|False|storages|9.7%|None|Support for many storage backends in Django|1786943|
|thrift-sasl|0.4.3|False|thrift_sasl|38.1%|None|Thrift SASL Python module that implements SASL transports for Thrift (`TSaslClientTransport`).|1778142|
|bitstring|3.1.9|False|bitstring|9.9%|None|Simple construction, analysis and modification of binary data.|1769946|
|yq|3.1.0|False|yq|15.6%|None|Command-line YAML/XML processor - jq wrapper for YAML/XML documents|1768210|
|apache-airflow-providers-sqlite|3.2.1|False|airflow|43.8%|None|Provider for Apache Airflow. Implements apache-airflow-providers-sqlite package|1766955|
|bottle|0.12.23|False|bottle|9.5%|None|Fast and simple WSGI-framework for small web-applications.|1763862|
|docker-compose|1.29.2|False|compose|16.9%|None|Multi-container orchestration for Docker|1757647|
|django-extensions|3.2.1|False|django_extensions|21.5%|None|Extensions for Django|1754316|
|orderedmultidict|1.0.1|False|orderedmultidict|12.9%|None|Ordered Multivalue Dictionary|1753563|
|apache-airflow-providers-imap|3.0.0|False|airflow|58.3%|None|Provider for Apache Airflow. Implements apache-airflow-providers-imap package|1751253|
|azure-storage-file-share|12.10.1|False|azure|3.1%|None|Microsoft Azure Azure File Share Storage Client Library for Python|1750688|
|wandb|0.13.4|True|wandb|39.1%|None|A CLI and library for interacting with the Weights and Biases API.|1748983|
|google-cloud-kms|2.12.3|True|google.cloud.kms|0%|None|Cloud Key Management Service (KMS) API client library|1747880|
|apache-airflow-providers-ftp|3.1.0|False|airflow|62.2%|None|Provider for Apache Airflow. Implements apache-airflow-providers-ftp package|1743563|
|azure-mgmt-hdinsight|9.0.0|False|azure.mgmt.hdinsight|0%|None|Microsoft Azure HDInsight Management Client Library for Python|1736813|
|setuptools-rust|1.5.2|False|setuptools_rust|60.6%|None|Setuptools Rust extension plugin|1736702|
|asyncio|3.4.3|False|asyncio|11.4%|None|reference implementation of PEP 3156|1734798|
|pgpy|0.5.4|False|pgpy|30.1%|None|Pretty Good Privacy for Python|1733466|
|optuna|3.0.3|False|benchmarks|43.8%|None|A hyperparameter optimization framework|1724428|
|optuna|3.0.3|True|optuna|47.4%|None|A hyperparameter optimization framework|1724428|
|rtree|1.0.1|True|rtree|49.3%|None|R-Tree spatial index for Python GIS|1723875|
|autopage|0.5.1|True|autopage|76.7%|None|A library to provide automatic paging for console output|1716910|
|azure-mgmt-privatedns|1.0.0|False|azure.mgmt.privatedns|0%|None|Microsoft Azure DNS Private Zones Client Library for Python|1705237|
|azure-mgmt-apimanagement|3.0.0|False|azure.mgmt.apimanagement|0%|None|Microsoft Azure API Management Client Library for Python|1703252|
|azure-mgmt-subscription|3.1.1|True|azure.mgmt.subscription|0%|None|Microsoft Azure Subscription Management Client Library for Python|1699697|
|azure-mgmt-sqlvirtualmachine|0.5.0|False|azure.mgmt.sqlvirtualmachine|34%|None|Microsoft Azure SQL Virtual Machine Management Client Library for Python|1694944|
|hyperopt|0.2.7|False|hyperopt|10.6%|None|Distributed Asynchronous Hyperparameter Optimization|1694151|
|dynaconf|3.1.11|False|dynaconf|17.8%|None|The dynamic configurator for your Python Project|1691014|
|azure-mgmt-security|2.0.0|True|azure.mgmt.security|0%|None|Microsoft Azure Security Center Management Client Library for Python|1688588|
|zstandard|0.18.0|True|zstandard|36.9%|None|Zstandard bindings for Python|1686735|
|cfn-flip|1.3.0|False|cfn_clean|14.3%|None|Convert AWS CloudFormation templates between JSON and YAML formats|1685878|
|cfn-flip|1.3.0|False|cfn_flip|26.1%|None|Convert AWS CloudFormation templates between JSON and YAML formats|1685878|
|cfn-flip|1.3.0|False|cfn_tools|31.4%|None|Convert AWS CloudFormation templates between JSON and YAML formats|1685878|
|azure-mgmt-netapp|9.0.1|True|azure.mgmt.netapp|0%|None|Microsoft Azure NetApp Files Management Client Library for Python|1683657|
|azure-mgmt-kusto|3.0.0|True|azure.mgmt.kusto|0%|None|Microsoft Azure Kusto Management Client Library for Python|1677586|
|rapidfuzz|2.12.0|True|rapidfuzz|95.7%|None|rapid fuzzy string matching|1676014|
|azure-mgmt-managedservices|6.0.0|False|azure.mgmt.managedservices|0%|None|Microsoft Azure Managed Services Client Library for Python|1674935|
|jupyterlab|3.5.0|False|jupyterlab|23.4%|None|JupyterLab computational environment|1666785|
|flask-oidc|1.4.0|False|flask_oidc|10.9%|None|OpenID Connect extension for Flask|1664376|
|pycares|4.2.2|False|pycares|11.3%|None|Python interface for c-ares|1662707|
|azure-mgmt-imagebuilder|1.1.0|True|azure.mgmt.imagebuilder|0%|None|Microsoft Azure Image Builder Client Library for Python|1661997|
